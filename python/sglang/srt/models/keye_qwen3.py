...
try:
    ...
    print_info_once(
        """
        flash_attn_varlen_func is not available, if sglang version is 0.4.6.post5,
        please try to pip install flash-attn==2.7.4.post1
    """
    )
...
class KeyeVL1_5ForConditionalGeneration(nn.Module):
    ...
    def forward(
        ...
        if get_tensor_model_parallel_rank() == 0:
            logger.info("Use Keye-Qwen3 model to forward!")
